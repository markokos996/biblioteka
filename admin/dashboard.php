...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Sistem za upravljanje bibliotekom | Radna ploca administratora</title>
    <!-- BOOTSTRAP  -->
...
<!-- header kraj-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Radna ploca administratora</h4>
