...
<head>
    ...
    <title>Sistem za upravljanje bibliotekom | Detalji idanim knjigama</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Detalji izdanim knjigama</h4>
...
<div class="form-group">
<label>Datum izavanja knjige :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div>


<div class="form-group">
<label>Datum vracanja knjige :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Vracena knjiga </button>
