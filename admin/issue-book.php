...
if($lastInsertId)
{
$_SESSION['msg']="Knjiga vracena uspjesno";
...
<head>
    ...
    <title>Sistem za upravljanje bibliotekom | Izdana knjiga</title>
...
<!-- MENU SECTION END-->
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Izdana knjiga</h4>
...
<label>sifra studenta<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Izdana knjiga</button>
