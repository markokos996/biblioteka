...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title> Sistem za upravljanje bibliotekom | Registracija studenta</title>
    <!-- BOOTSTRAP  -->
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line"> Moj profil</h4>
...
<label>Identifikacioni broj studenta: </label>
...
<div class="form-group">
<label>Zadnji datum promjene : </label>
...
<?php } else { ?>
<span style="color: red"> Blokiran</span>
<?php }?>
</div>


<div class="form-group">
<label> Unesi puno ime i prezime </label>
...
<div class="form-group">
<label>Unesi email adresu</label>
<input class="form-control" type="email" name="email" id="emailid" value="<?php echo htmlentities($result->EmailId);?>"  autocomplete="off" required readonly />
</div>
<?php }} ?>
                              
<button type="submit" name="update" class="btn btn-primary" id="submit"> Promjeni podatke </button>
