...
<head>
    ...
    <title>Sistem za upravljanje bibliotekom | Upravljaj kategorijama</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Upravljaj kategorijama</h4>
    </div>
     <div class="row">
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="#" class="btn btn-success btn-xs">Aktivno</a>
                                            <?php } else {?>
                                            <a href="#" class="btn btn-danger btn-xs">Neaktivno</a>
                                            <?php } ?></td>
