...
$query->execute();
$_SESSION['msg']="Informacije o knjizi izmjenjene";
...
<head>
    ...
    <title>Sistem za upravljanje bibliotekom | Upravljaj knjigama</title>
    <!-- BOOTSTRAP  -->
...
<p class="help-block">Sifra knjige mora biti jedinstvena</p>
</div>
